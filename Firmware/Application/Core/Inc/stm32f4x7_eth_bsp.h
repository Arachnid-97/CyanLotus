...
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
/* Specific defines for EXTI reset function */
#define ETH_RESET_PIN                 GPIO_Pin_1
#define ETH_RESET_GPIO_PORT           GPIOC
#define ETH_RESET_GPIO_CLK            RCC_AHB1Periph_GPIOC
#define ETH_RESET_GPIO_APBxClkCmd     RCC_AHB1PeriphClockCmd
