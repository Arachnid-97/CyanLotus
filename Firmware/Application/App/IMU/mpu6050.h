...
enum Ascale
{
  AFS_2G = MPU6050_ACCEL_FS_2,
  AFS_4G = MPU6050_ACCEL_FS_4,
  AFS_8G = MPU6050_ACCEL_FS_8,
  AFS_16G = MPU6050_ACCEL_FS_16
};

enum Gscale
{
  GFS_250DPS = MPU6050_GYRO_FS_250,
  GFS_500DPS = MPU6050_GYRO_FS_500,
  GFS_1000DPS = MPU6050_GYRO_FS_1000,
  GFS_2000DPS = MPU6050_GYRO_FS_2000
};
